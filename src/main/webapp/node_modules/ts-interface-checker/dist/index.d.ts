import { ITypeSuite, TType } from "ts-interface-checker/dist/types";
import { IErrorDetail } from "ts-interface-checker/dist/util";
/**
 * Export functions used to define interfaces.
 */
export { TArray, TEnumType, TEnumLiteral, TFunc, TIface, TLiteral, TName, TOptional, TParam, TParamList, TProp, TTuple, TType, TUnion, TIntersection, array, enumlit, enumtype, func, iface, lit, name, opt, param, tuple, union, intersection, BasicType, ITypeSuite, } from "ts-interface-checker/dist/types";
export { VError, IErrorDetail } from 'ts-interface-checker/dist/util';

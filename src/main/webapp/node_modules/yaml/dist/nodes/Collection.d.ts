...
import { NodeBase } from 'yaml/dist/nodes/Node.js';
export declare function collectionFromPath(schema: Schema, path: unknown[], value: unknown): import("yaml/dist/nodes/Node.js").Node;

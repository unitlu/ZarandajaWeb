...
const _hashConfig = /*#__PURE__*/ _interop_require_default(require("tailwindcss/lib/util/hashConfig"));
const _resolveconfig = /*#__PURE__*/ _interop_require_default(require("tailwindcss/lib/public/resolve-config"));
const _resolveConfigPath = /*#__PURE__*/ _interop_require_default(require("tailwindcss/lib/util/resolveConfigPath"));
const _setupContextUtils = require("tailwindcss/lib/lib/setupContextUtils");
const _parseDependency = /*#__PURE__*/ _interop_require_default(require("tailwindcss/lib/util/parseDependency"));
const _validateConfig = require("tailwindcss/lib/util/validateConfig.js");
